...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', type=str, required=True, help='input file', default= )
    parser.add_argument('-o', '--output', type=str, required=True, help='output file', default= )
